...
public class ExpNSGAIISelectInstancesAndLearningKB {
    ...
    public static void main(String[] args) throws 
        ...
        for (String aDatasetName : datasetName) {

            datasetLocation = "./dataset/" + aDatasetName + "/";
            configFile = "config-" + aDatasetName + ".txt";
            pathResult = "./result/" + aDatasetName + "/";
            pathResultAll = "./result/";

            System.out.println(aDatasetName);
            ...
            Printer.printFinalResult(aDatasetName, pathResult, pathResultAll);
        } //end for       
    } //end main   
